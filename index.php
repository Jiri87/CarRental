...
<?php require_once "hlavicka.php"; ?>
    ...
    <article>
        <header>
            ...
            <section>
                <p>Vítejte na našem webu kde si můžete vybrat z velké palety amerických vozů a okusit tak sílu muscle car.</p>
                <p>Jsme automobiloví nadšenci do amerických aut a v naší malé firmě Vám zprostředkujeme nevšední zážitek z těchto vozidel</p>
            </section>

           
        <header>
             <h2>Na jak dlouho Vám vozidlo zapůjčíme?</h2>
        </header>
            <section>
                <p>Automobil zapůjčujeme od jednoho dne až po dobu jednoho týdne. Ke každému zákazníkovi přistupujeme individuálně a k jeho plné spokojenosti.</p><br/>
            </section>  

            
        <header>
            <h2>Na jaké příležitosti vozidla zapůjčujeme?</h2>
        </header>
            <section>
                <p>Chcete mít na svatbě pravou ameriku, díky nám to můžete zažít, můžete vozidlo řídit sami, nebo Vám poskytneme osobního řidiče. Nebo chcete darovat nevšední zážitek, vše rádi zařídíme.</p><br/>
            </section>


        <header>
            <h2 id="dodge">Dodge</h2>
        </header>
            <section>
